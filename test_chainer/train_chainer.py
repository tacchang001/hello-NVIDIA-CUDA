...
class Trainer(object):
    ...
    def _load_cifar100(self):
        ...
        self.x_train = np.transpose(self.x_train.astype('f'), (0, 3, 1, 2))
        self.y_train = self.y_train.flatten().astype('i')
        self.x_test = np.transpose(self.x_test.astype('f'), (0, 3, 1, 2))
        self.y_test = self.y_test.flatten().astype('i')
