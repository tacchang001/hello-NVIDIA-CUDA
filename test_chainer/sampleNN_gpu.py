...
# GPU化
# http://labs.timedia.co.jp/2017/04/chainergpumnist-train-mnistpy--gpu-0-gpuhttpsgithubcompfnetchainertreemasterexamplesmnist-parseradd.html
import pandas as pd
import numpy as np
...
def learning():
    ...
    # trainerの拡張をしておく
    trainer.extend(extensions.Evaluator(test_iter, model, device=device_id))  # 精度の確認
